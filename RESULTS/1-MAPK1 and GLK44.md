...
Please note that the limit for recognising the sequence can exceed the 4
numbers of characters (i.e, you can recognise any piece of sequence with no
limit on the number of nucleotides)
Upon the user’s input of the data file location and sequence wished to be
analysed the code runs. The code then prints the number of times the desired sequence has appeared in the gene and the spacer length between two consecutive occurrences of the element.
